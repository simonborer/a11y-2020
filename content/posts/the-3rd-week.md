...
<section id="collection">
    ...
    <p class="post-only"><img src="/images/analytics.svg" alt="" style="max-width: 25%;float:right;">Since you've already defined, in your test plan, the "whys", the "hows" and the "what types" of data you're collecting, the actual process of collecting data should be fairly straightforward.</p>
...
<section>
    <p class="post-only"><img src="/images/compile.svg" alt="" style="max-width: 25%;float:right;">For those of you who are working exclusively quantitative data, this will be sort of a mini-step. You may write some Excel formulae in advance, fill out your spreadsheet during testing and be done with it.</p>
...
<section id="analysis">
    ...
    <p>Just like in the compilation stage, the complexity of this step is defined by the kind of data you're dealing with, and the kinds of questions you asked.<img src="/images/analysis.svg" alt="" style="max-width: 25%;float:right;padding:1rem;"></p>
...
<section>
    ...
    <p><img src="/images/report.svg" alt="" style="max-width: 25%;float:right;padding:1rem;">Keep solutions specific and positive - 'don't use hamburger menus' isn't an action, it's a non-action.</p>
...
<section>
    ...
    <p><img src="/images/present.svg" alt="" style="max-width: 25%;float:right;padding:1rem;">Now that your report is ready, you'll need to give a sort of 'executive summary' as a 5-minute presentation. My advice: start with the conclusions and work backwards.</p>
</section>
<section>
